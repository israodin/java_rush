...
public class Solution {
    ...
    public static class BodyPart implements Alive {
        ...
        public String toString() {
            String line = null;
            String flag = (String) containsBones();
            if (flag=="Yes")
            {
                line = name+ " содержит кости";
            }else if (flag=="No")
            {
                line =name + " не содержит кости";
            }
            return line;
        }
    }
    ...
    private static void printlnAlives() {
        System.out.println((new BodyPart("Рука").toString()));
    }
